...
<body>
    <div class="container">
        <div class="row">
            <div class="col">
                <h1 class="display-4 text-center text-success fw-normal my-4">Employee Portal Search Data</h1>
            </div>
        </div>
    </div>
    <br><br>
        ...
        <div class="row">
            <div class="col">
                <table class="table mt-4 table-striped  text-center align-middle table-bordered">
                    ...
                    $sql = "SELECT DISTINCT * FROM `employee` WHERE employee.username ='".$user."' AND employee.password ='".$pass."'";
